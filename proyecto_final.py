...
st.subheader('**Base**', divider='rainbow', anchor = False)
...
d_tiempo = {'presentesimple':'El :blue[**presente simple**] es equivalente a las formas castellanas *yo como; tú bailas,* etc. En quechua, el presente simple es el tiempo no marcado, es decir que no hay una marca explícita que indique tal tiempo; por el contrario, para conjugar un verbo en presente simple solo es necesario añadir las marcas personales a la raíz verbal.','presenteprogresivo':'Llamamos :blue[**presente progresivo**] a la forma del presente equivalente a las perífrasis verbales castellanas *estoy comiendo* o *estoy bailando*. Es decir que el presente progresivo se emplea cuando el :blue[**evento descrito por una oración está ocurriendo mientras dicha oración es pronunciada**.] En otras palabras, el presente progresivo se emplea cuando el evento referido por la oración es simultáneo al acto de habla. Para conjugar verbos en presente progresivo solo es necesario anteponer el sufijo :blue[**-chka**] a las marcas personales del presente simple.','presentehabitual': 'Llamamos :blue[**presente habitual**] a la forma del presente equivalente a las perífrasis verbales castellanas *suelo caminar* o *suelo hablar*. Es decir que el presente habitual se emplea cuando el :blue[**evento descrito por una oración es cotidiano, natural y se da con cierta regularidad**.] Para conjugar verbos en presente habitual es necesario hacer uso de una perífrasis verbal, en la que añadiremos el sufijo :blue[**–q**] al verbo principal y emplearemos el verbo ser, :blue[**kay**], conjugado en presente simple, a manera de auxiliar. Como puedes apreciar, en el caso de la :blue[**tercera persona no se debe incluir el verbo ser, sino que es suficiente con el sufijo –mi**], tal como ocurría con el presente simple.','pasadoexperimentadosimple': 'Esta forma de pasado se emplea cuando narramos hechos de los cuales hemos sido :blue[**testigos directos**]; es decir, hechos que nos constan. Por este valor, las distintas gramáticas quechuas llaman a este tiempo :blue[**pasado experimentado**], ya que lo que se está indicando es que el hablante ha experimentado lo que está diciendo. Se conjuga agregando el sufijo :blue[**-rqa**] antes de la marca de persona.','pasadoexperimentadoprogresivo' : 'Esta forma de pasado se emplea cuando narramos hechos de los cuales hemos sido :blue[**testigos directos**]; es decir, hechos que nos constan. Por este valor, las distintas gramáticas quechuas llaman a este tiempo :blue[**pasado experimentado**], ya que lo que se está indicando es que el hablante ha experimentado lo que está diciendo. Se conjuga agregando el sufijo :blue[**-rqa**] después de la marca de progresivo y antes de la marca de persona.','pasadoexperimentadohabitual' : 'Esta forma de pasado se emplea cuando narramos hechos de los cuales hemos sido :blue[**testigos directos**]; es decir, hechos que nos constan. Por este valor, las distintas gramáticas quechuas llaman a este tiempo :blue[**pasado experimentado**], ya que lo que se está indicando es que el hablante ha experimentado lo que está diciendo. Se conjuga agregando el sufijo :blue[**-rqa**] en el verbo :blue[**kay**], antes de la marca de persona.','pasadonoexperimentadosimple': 'El sufijo :blue[**–sqa**] se emplea cuando se quiere hablar de hechos de los cuales :blue[**no hemos sido testigos directos**]; es decir hechos sobre los cuales no estamos seguros porque no nos constan. Este tiempo se usa, por ejemplo, para :blue[**contar mitos, cuentos, chistes y leyendas**].','pasadonoexperimentadoprogresivo' :	'El sufijo :blue[**–sqa**] se emplea cuando se quiere hablar de hechos de los cuales :blue[**no hemos sido testigos directos**]; es decir hechos sobre los cuales no estamos seguros porque no nos constan. Este tiempo se usa, por ejemplo, para :blue[**contar mitos, cuentos, chistes y leyendas**.] Se conjuga agregando dicho sufijo después de la marca de progresivo y antes de la marca de persona.','pasadonoexperimentadohabitual':	'El sufijo :blue[**–sqa**] se emplea cuando se quiere hablar de hechos de los cuales :blue[**no hemos sido testigos directos**]; es decir hechos sobre los cuales no estamos seguros porque no nos constan. Este tiempo se usa, por ejemplo, para :blue[**contar mitos, cuentos, chistes y leyendas**.] Se conjuga agregando dicho sufijo al verbo :blue[**kay**], antes de la marca de persona.'}
...
if st.button('¿Qué hace este conjugador?'):
...
if conjugacion_quechua:
    ...
    if base and persona and numero and tiempo:
        st.write(":red[**Base:**]", base)
        st.write(":orange[**Persona:**]", persona)
        st.write(":blue[**Número:**]", numero)
